...
def create_database():
    ...
    cursor.execute('''
        ...
        ('Васильев Владимир Львович','Преподаватель истории'),
    ...
    cursor.execute(''' 
        ...
        ("Понедельник", "2024-11-04", 2, 2, 5, 1, 1),
        ("Понедельник", "2024-11-04", 3, 3, 2, 2, 2),  
        ("Понедельник", "2024-11-04", 4, 7, 7, 3, 2), 
        ("Понедельник", "2024-11-04", 5, 11, 3, 4, 2),  
        ("Понедельник", "2024-11-04", 1, 1, 1, 3, 3),  
        ("Понедельник", "2024-11-04", 2, 8, 8, 4, 3),
        ("Понедельник", "2024-11-04", 2, 9, 8, 3, 4),  
        ("Понедельник", "2024-11-04", 3, 3, 2, 1, 4),
        ("Понедельник", "2024-11-04", 4, 8, 2, 1, 4),
        ("Понедельник", "2024-11-04", 2, 13, 4, 2, 5),  
        ("Понедельник", "2024-11-04", 3, 9, 8, 5, 5), 

        ("Вторник", "2024-11-05", 2, 5, 3, 1, 1),  
        ("Вторник", "2024-11-05", 3, 10, 6, 4, 1),
        ("Вторник", "2024-11-05", 3, 12, 7, 2, 2),  
        ("Вторник", "2024-11-05", 4, 1, 1, 3, 2),  
        ("Вторник", "2024-11-05", 1, 1, 1, 3, 3),  
        ("Вторник", "2024-11-05", 2, 8, 8, 4, 3),
        ("Вторник", "2024-11-05", 2, 9, 8, 3, 4),  
        ("Вторник", "2024-11-05", 3, 3, 2, 1, 4),
        ("Вторник", "2024-11-05", 4, 8, 2, 1, 4),
        ("Вторник", "2024-11-05", 1, 13, 4, 2, 5),  
        ("Вторник", "2024-11-05", 2, 9, 8, 5, 5), 
        ("Вторник", "2024-11-05", 2, 9, 8, 5, 5), 

        ("Среда", "2024-11-06", 1, 11, 3, 1, 1),  
        ("Среда", "2024-11-06", 2, 2, 5, 4, 1),
        ("Среда", "2024-11-06", 3, 6, 2, 3, 1),
        ("Среда", "2024-11-06", 3, 12, 7, 2, 2),  
        ("Среда", "2024-11-06", 4, 1, 1, 3, 2),  
        ("Среда", "2024-11-06", 1, 1, 1, 3, 3),  
        ("Среда", "2024-11-06", 2, 8, 8, 4, 3),
        ("Среда", "2024-11-06", 2, 9, 8, 3, 4),  
        ("Среда", "2024-11-06", 3, 3, 2, 1, 4),
        ("Среда", "2024-11-06", 1, 13, 4, 2, 5),  
        ("Среда", "2024-11-06", 2, 9, 8, 5, 5), 
        ("Среда", "2024-11-06", 2, 9, 8, 5, 5), 

        ("Четверг", "2024-11-07", 1, 10, 6, 1, 1),  
        ("Четверг", "2024-11-07", 2, 2, 5, 4, 1),
        ("Четверг", "2024-11-07", 3, 4, 4, 2, 2),  
        ("Четверг", "2024-11-07", 4, 1, 1, 3, 2),  
        ("Четверг", "2024-11-07", 1, 1, 1, 3, 3),  
        ("Четверг", "2024-11-07", 2, 8, 8, 4, 3),
        ("Четверг", "2024-11-07", 3, 2, 5, 2, 3),
        ("Четверг", "2024-11-07", 2, 9, 8, 3, 4),  
        ("Четверг", "2024-11-07", 3, 3, 2, 1, 4),
        ("Четверг", "2024-11-07", 4, 6, 3, 3, 4), 
        ("Четверг", "2024-11-07", 1, 13, 4, 2, 5),  
        ("Четверг", "2024-11-07", 2, 9, 8, 5, 5), 
        ("Четверг", "2024-11-07", 3, 8, 2, 1, 5), 
 

        ("Пятница", "2024-11-08", 1, 6, 2, 1, 1),  
        ("Пятница", "2024-11-08", 2, 2, 5, 4, 1),
        ("Пятница", "2024-11-08", 3, 4, 4, 2, 2),  
        ("Пятница", "2024-11-08", 4, 1, 1, 3, 2),  
        ("Пятница", "2024-11-08", 1, 1, 1, 3, 3),  
        ("Пятница", "2024-11-08", 2, 8, 8, 4, 3),
        ("Пятница", "2024-11-08", 3, 2, 5, 2, 3),
        ("Пятница", "2024-11-08", 2, 9, 8, 3, 4),  
        ("Пятница", "2024-11-08", 3, 3, 2, 1, 4),
        ("Пятница", "2024-11-08", 4, 6, 3, 3, 4), 
        ("Пятница", "2024-11-08", 4, 3, 8, 2, 5),   
        ("Пятница", "2024-11-08", 5, 8, 2, 1, 5);
    ''')
